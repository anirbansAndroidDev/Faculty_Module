...
public class CoverFlowItem extends ImageView {
	...
	public void setImageBitmap(Bitmap bitmap, int originalImageHeight,
		...
		LinearLayout.LayoutParams vuParams=new LinearLayout.LayoutParams((int)(mBitmapWidth * mScaleX), (int)(mBitmapHeight * mScaleY));
		vuParams.setMargins(13, 13, 13, 13);
		
		
		setLayoutParams(vuParams);
