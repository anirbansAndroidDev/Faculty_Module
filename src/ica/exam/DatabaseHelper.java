...
public class DatabaseHelper extends SQLiteOpenHelper {
	...
	public static final String FLD_FACULTY_CODE = "s_faculty_code";
	public static final String FLD_PWD = "s_pwd";
	public static final String FLD_FACULTY_MOBILE = "s_faculty_mobile";
	public static final String FLD_FACULTY_FIRST_NM = "s_faculty_f_nm";
	public static final String FLD_FACULTY_LAST_NM = "s_faculty_last_nm";
	public static final String FLD_FACULTY_IMG_PATH = "s_faculty_img_path";

	public static final String TBL_BATCH = "tb_batch";

	public static final String FLD_BATCH_ID = "s_batch_id";
	public static final String FLD_BATCH_NAME = "s_batch_name";
	public static final String FLD_BATCH_SUBEJCT_NAME = "s_batch_subject_name";

	public static final String TBL_SESSION = "tb_session";

	public static final String FLD_SESSION_ID = "s_session_id";
	public static final String FLD_SESSION_BATCH_ID = "s_session_batch_id";
	public static final String FLD_SESSION_NAME = "s_session_name";
	// public static final String FLD_BATCH_START = "s_batch_start";
	// public static final String FLD_BATCH_END = "s_batch_end";
	// public static final String FLD_BATCH_FACULTY_ID = "s_batch_faculty_id";
	// public static final String FLD_BATCH_SUBJECT_NAME =
	// "s_batch_subject_name";

	public static final String TBL_CHAPTER = "tb_chapter";

	public static final String FLD_CHAPTER_ID = "s_chapter_id";
	public static final String FLD_CHAPTER_NAME = "s_chapter_name";
	...
	public static final String FLD_QUESTION_SESSION_NO = "s_question_session_no";
	public static final String FLD_QUESTION_CHAPTER_ID = "s_question_chapter_id";
	public static final String FLD_QUESTION_BATCH_ID = "s_question_batch_id";
	...
	public final static String CREATE_TBL_USER = "CREATE TABLE IF NOT EXISTS "
			+ TBL_USER + " (" + FLD_ROWID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + FLD_FACULTY_CODE
			+ " VARCHAR(100) NOT NULL, " + FLD_PWD + " VARCHAR(25) NOT NULL ,"
			+ FLD_FACULTY_MOBILE + " VARCHAR(25) ," + FLD_FACULTY_FIRST_NM
			+ " VARCHAR(25) ," + FLD_FACULTY_LAST_NM + " VARCHAR(25) ,"
			+ FLD_FACULTY_IMG_PATH + " VARCHAR(25));";
	...
	public static final String CREATE_TBL_BATCH = "CREATE TABLE IF NOT EXISTS "
			+ TBL_BATCH + " (" + FLD_ROWID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + FLD_BATCH_ID
			+ " VARCHAR(15) NOT NULL, " + FLD_BATCH_NAME + " TEXT ,"
			+ FLD_BATCH_SUBEJCT_NAME + " TEXT " + ");";
	// + FLD_BATCH_START + " VARCHAR(4) NOT NULL, " + FLD_BATCH_END
	// + " VARCHAR(7) NOT NULL, " + FLD_BATCH_FACULTY_ID
	// + " VARCHAR(7) NOT NULL, " + FLD_BATCH_SUBJECT_NAME
	// + " VARCHAR(7) NOT NULL" + ");";

	public static final String CREATE_TBL_SESSION = "CREATE TABLE IF NOT EXISTS "
			+ TBL_SESSION
			+ " ("
			+ FLD_ROWID
			...
			+ FLD_SESSION_NAME
			+ " TEXT ,"
			+ FLD_SESSION_BATCH_ID + " VARCHAR(7) " + ");";

	public static final String CREATE_TBL_CHAPTER = "CREATE TABLE IF NOT EXISTS "
			+ TBL_CHAPTER
			+ " ("
			+ FLD_ROWID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, "
			...
			+ "  VARCHAR(7) NOT NULL, "
			+ FLD_SESSION_ID
			+ "  VARCHAR(7) NOT NULL, " + FLD_CHAPTER_NAME + " TEXT " + ");";
	...
	// <chapter BatchDisplayname="X998/001/Busine/10-05-2012"
	// ID="20006" ClassNo="1"
	// Chapter="Introduction to computer hardware and softwares"
	// ChapterID="7616">
	...
	private final String CREATE_TBL_EXAM = "CREATE TABLE IF NOT EXISTS "
			+ TBL_EXAM + " (" + FLD_ROWID
			+ " INTEGER PRIMARY KEY AUTOINCREMENT, " + FLD_CHAPTER_ID
	...
	public final static String CREATE_TBL_QUESTION_DETAILS = "CREATE TABLE IF NOT EXISTS "
			...
			+ FLD_QUESTION_TEXT
			+ " VARCHAR(100) NOT NULL , "
			+ FLD_QUESTION_SESSION_NO
			+ " VARCHAR(15) NOT NULL , "
			+ FLD_QUESTION_CHAPTER_ID
			+ " VARCHAR(15) NOT NULL , "
			+ FLD_QUESTION_BATCH_ID
			+ " VARCHAR(15) NOT NULL , "
	...
	public static final String DROP_TBL_BATCH = "DROP TABLE IF EXISTS "
			+ TBL_BATCH;

	public static final String DROP_TBL_CHAPTER = "DROP TABLE IF EXISTS "
			+ TBL_CHAPTER;
	...
	public final static String DROP_TBL_SESSION = "DROP TABLE IF EXISTS "
			+ TBL_SESSION;
