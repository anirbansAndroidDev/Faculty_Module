...
public class Receipt extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setTitle("Receipt Details- [" + facultyDetails.getFacultyID() + "]");
	...
	public void ShowCourseData(String CourseID, String CourseNm,
		...
		txtReceiptMrdt.setOnClickListener(new OnClickListener() {
		...
		txtReceiptMrno.setOnClickListener(new OnClickListener() {
		...
		txtReceiptFees.setOnClickListener(new OnClickListener() {
