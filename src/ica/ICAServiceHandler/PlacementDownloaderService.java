...
import com.coverflow.PlacementSelectorActivity.MonthItems;
...
/**
 * Placement Details Service and DB operation Handler Class
 * 
 * @author User
 * 
 */
public class PlacementDownloaderService extends Activity {
	...
	/**
	 * Download latest placement details based on strPlacementType value
	 * 
	 * @param strPlacementType
	 * @return
	 */
				...
				if (placementBlock != null
					...
					for (int cnt = 0; cnt < placementItemCnt; cnt++) {
						...
						if (placementSoap != null
							...
							try {
								upsertPlacement(newPlacementInfo);
	...
	/**
	 * UPSERT Placement Details to DB
	 * 
	 * @param placementInfo
	 * @return
	 */
	@SuppressWarnings("deprecation")
	private long upsertPlacement(PlacementInfo placementInfo) {
		...
		try {
			...
			if ((placementInfo != null && values != null)) {
				...
				if (lreturn > 0) {
					// Download and Save placement Bitmap
	...
	/**
	 * Update Bitmap of Placed Student
	 * 
	 * @param PlacementInfo
	 * @return true/false on success
	 */
	@SuppressWarnings("deprecation")
	public boolean updateBitmapToBlob(PlacementInfo placementInfo) {
	...
	/**
	 * Fetch Placement Bitmap from DB
	 * 
	 * @param PlacementInfo
	 * @return Bitmap
	 */
	...
	/**
	 * Get All Placement Details (filter based on durationField (All India ,
	 * Days or month)
	 * 
	 * @return List of PlacementInfo
	 */
	@SuppressWarnings("deprecation")
	...
	/**
	 * Create Table if already not exists Set placement row of durationField to
	 * No(N) if Y
	 */
	...
	/**
	 * 
	 * DROP and CREATE Placement Details Table
	 * 
	 * @param curContext
	 */
